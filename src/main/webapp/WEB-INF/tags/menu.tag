								...
								<div class="navbar-login">
									<div class="row">
										...
										<div class="col-lg-8">
											...
											class="btn btn-primary btn-block btn-sm" style="background-color: rgb(255, 140, 198); border-radius: 6px; color: rgb(255, 236, 245);border: 2px solid #34302D;font-size: 15px;margin-left: -30px;">New Achiev</a>
                         					</p>
										</div>
										</sec:authorize>
									</div>
